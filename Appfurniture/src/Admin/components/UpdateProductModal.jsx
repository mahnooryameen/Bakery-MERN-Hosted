...
export default function UpdateProductModal() {
  ...
  const handleShow = () => {
      axios.get(`${AppRoute}api/get-all-brands`).then(json => {
          ...
          axios.get(`${AppRoute}api/get-all-categories`).then(json => {
                ...
                .then((snapshot) => {
                    ...
                    getDownloadURL(snapshot.ref)
                        .then((url) => {
                            ...
                            console.log(payload)
                            axios.put(`${AppRoute}api/update-product`, payload).then((json) => {
      ...
      <Modal show={show} centered backdrop="static" onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <form onSubmit={AddProduct}>
            ...
            <div className="row">
            <div className="col">
                <FloatingLabel controlId="productid" label="Product id" className="mb-3 text-secondary"                                >
                  <Form.Control type="text" placeholder="Product id" value={_id} onChange={(e) => set_id(e.target.value)} />
                </FloatingLabel>
              </div>
              <div className="col">
